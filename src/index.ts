...
const main = async () => { // Make main async
...
if (typeof window !== 'undefined' && typeof process === 'undefined') { // Also check process to avoid running in Node for Vite build/dev server if not careful
  main().catch(error => {
